...
\subsection{Presguntas de investigación}
...
\begin{enumerate}
 ...
 \item El usuario recibirá una lista con las tareas a realizar durante la evaluación. Para llevarlas a cabo, el usuario evaluado podrça tomarse todo el tiempo que estime oportuno.
 \item Durante la evaluación se mantendrá una videollamada con el evaluado para observar todas las reacciones a la hora de realizar las tareas en la aplicación. El moderador también apuntará los tiempos que tarda en finalizar las tareas.
 ...
 \item Tras finalizar con las tareas de la evaluación, el usuario rellenará un pequeño formulario online para expresar su opinión y experiencia de uso con la aplicación.
...
HERRAMIENTAS QUE SE UTILIZARON EN LA EVALUACION: SKYPE, CAMTASIA STUDIO,...
...
\begin{enumerate}
 \item Mostrar al usuario la lista de tareas a realizar con la aplicación. Esta lista será acesible mediante una web pública en internet. Se informará al usuario de que deberá realizar las tareas sin ayuda, ni interrupciones hasta el final.
 ...
 \item Iniciar una breve sesión de \textit{debriefing} con el usuario tras finalizar las tareas. El moderador solicitará al usuario que rellene un pequeño cuestionario online para obtener sus impresiones, opiniones y experiencias de uso con la aplicación evaluada.
\end{enumerate}

\subsection{Datos que se van a recolectar}

En cada evaluación con usuarios se recogerán una serie de datos que definirán caracaerísticas básicas de la persona evaluada. Tales como nombre, edad, profesión, intereses, etcétera.
...
\subsubsection{Resultados de los cuestionarios}
