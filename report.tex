...
\includeonly{summary, abstract, introduction, waveMigration, androidApp, technologies, methodology, architecture, results, futureWork, ref, append} %include archives
