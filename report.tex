...
\includeonly{summary, abstract, introduction, artState, technologies, waveMigration, androidApp, methodology, architecture, results, futureWork, ref, append} %include archives
...
\fancypagestyle{cover}
{
   ...
   \lfoot{\includegraphics[keepaspectratio, scale=0.8]{Media/cc.png}} %include image on left foote
