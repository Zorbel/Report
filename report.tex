...
\includeonly{summary, abstract, introduction, artState, methodology, technologies, waveMigration, design, architecture, evaluation, results, conclusions, ref, append} %include archives
